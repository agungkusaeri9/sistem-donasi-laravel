    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Data Kategori Program</div>
            </div>
        </div>
    ...
    <script>
        $(function() {
            let otable = $('#dTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('admin.programs-categories.data') }}',
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
            ...
            $('#myModal #myForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '{{ route('admin.programs-categories.store') }}',
                    type: 'POST',
                    dataType: 'JSON',
                    data: form.serialize(),
            ...
            $('body').on('click', '.btnDelete', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ url("admin/programs-categories/") }}' + '/' + id,
                            type: 'DELETE',
                            dataType: 'JSON',
                            success: function(response) {
                                Swal.fire({
