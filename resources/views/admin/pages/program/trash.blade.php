...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Sampah Program</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{ route('admin.dashboard') }}">Dashboard</a></div>
                <div class="breadcrumb-item">Sampah Program</div>
            </div>
        </div>
    ...
    <script>
        $(function() {
            ...
            $('body').on('click', '.btnDelete', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ url("admin/program/") }}' + '/' + id + '/permanent',
                            type: 'DELETE',
                            dataType: 'JSON',
            ...
            $('body').on('click', '.btnRestore', function(e) {
                ...
                Swal.fire({
                    title: 'Apakah Yakin?',
                    text: `${title} akan dipulihkan dari keranjang sampah!`,
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ url("admin/program/") }}' + '/' + id + '/restore',
                            type: 'POST',
                            dataType: 'JSON',
                            success: function(response) {
                                Swal.fire({
